...
你好，我叫徐宇超，现在在浙江工商大学读大四，在校专业是信息安全。大三上选择了前端作为我的职业方向，主要通过自学来学习前端，学习了大半年，自认为在 web 前端方向有了一定的知识基础和能力。现在希望在秋招能找到一份心仪的工作，同时也能同时也检验一下我的知识水平和学习成果，这次面试能过最好，不过的话也希望能暴露出自身的一些缺陷并改进。
